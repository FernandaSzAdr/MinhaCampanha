...
public class Long extends GenericDomain {
	...
	public Long(String nome, String cidade, String bairro, String estado, String cep, String ponto_referencia,
	...
	public Long(String nome, String cidade, String bairro, String estado, String cep, String ponto_referencia,
			String tipo_logradouro, short numero) {
		this.nome = nome;
		this.cidade = cidade;
		this.bairro = bairro;
		this.estado = estado;
